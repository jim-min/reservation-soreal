export default function Home() {
  return (
    <div className="flex flex-col items-center justify-items-center min-h-screen w-full p-8 pb-20 gap-16 font-[family-name:var(--font-geist-sans)]">
      ...
      <div className="w-full overflow-x-auto justify-items-center">
        <table className="w-75% border-collapse border border-gray-300">
          <thead>
            <tr>
