...
const InfoModal = ({ reserver, setOpenInfo }: InfoModalProps) => {
    ...
    return (
        <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-30 z-50"
            ...
            <div className="flex flex-col justify-between bg-white p-4 rounded-lg shadow-lg h-[300px] w-1/2 z-60 cursor-default">
                ...
                <div className="flex flex-col justify-center">
                    <p className="flex justify-center">예약자: {reserver.name}</p>
                    <button
